export class QueryProcessor {
    ...
    suggestRefinements(notes, backlinks) {
    ...
    summarizeFindings(searchResults, relatedNotes, backlinks) {
    ...
    extractTitle(content, fallbackPath) {
